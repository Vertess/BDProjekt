...
namespace BDProjekt
{
	class Funkcje
	{
        ...
        public void Login(TabControl tab, Uzytkownicy uzytkownik, System.Windows.Forms.Button button, string login = "", string password = "")
		{
			switch (uzytkownik)
			{
				...
				case Uzytkownicy.Klient:
                    ...
                    {
                        button.Text = "Wyloguj";
						this.Login(tab, Logowanie,button);
                        button.Text = "Wyloguj";
