...
-- --------------------------------------------------
-- Date Created: 09/16/2015 20:01:26
-- Generated from EDMX file: C:\Users\lukas\Desktop\Nowy folder\BDProjekt\BDProjekt\Ksiegarnia.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[AutorzyKsiazkis] (
    [IDAutorzyKsiazki] int IDENTITY(1,1) NOT NULL,
...
-- Creating primary key on [IDAutorzyKsiazki] in table 'AutorzyKsiazkis'
ALTER TABLE [dbo].[AutorzyKsiazkis]
ADD CONSTRAINT [PK_AutorzyKsiazkis]
    PRIMARY KEY CLUSTERED ([IDAutorzyKsiazki] ASC);
GO
...
-- Creating non-clustered index for FOREIGN KEY 'FK_dbo_AutorzyKsiazkis_dbo_Autors_Autor_IdAutora'
CREATE INDEX [IX_FK_dbo_AutorzyKsiazkis_dbo_Autors_Autor_IdAutora]
